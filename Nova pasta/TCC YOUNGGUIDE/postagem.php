...
<?php
        ...
        $sql= mysqli_query($conexao,"SELECT * FROM fotos where id_usu ='$row3'") or die ($mysqli->error);
    ...
    <div class="container">
        <div class="postagem">
            <div class="postaagem">
                ...
                ?>
                    <div class="topo">
                        <img src="imagens/book.png" alt="" width="20%"> 
                        <div class="titulo"><h1><?php echo $lin['titulo']?></h1></div>
                        <div class="icones">
                        ...
                        <!-- AQUI ESTA A DE CURTIDAS E FAVORITOS, ESTOU TENTANDO PASSAR AS ID'S ASSIM COMO VC ESTAVA PASSANDO OS PARAMETROS -->
                            ...
                            <script>
                                function executarScriptPHP() {
                                    ...
                                    xhttp.open("GET", "curtida.php?post_id=" + post_id + "&user_id=" + user_id, true);
                                    xhttp.send();
                                }
                            </script>
                            ...
                            <script>
                                function executarScriptPHP2() {
                                    ...
                                    xhttp.open("GET", "salva.php?post_id=" + post_id + "&user_id=" + user_id, true);
                                    xhttp.send();
                                }
                            </script>
                ...
                <div class="fundo">
                    ...
                    <div class="coment">
                        <div class="imagem-coment">
                            ...
                            <p class="usu"><?php echo $_SESSION['email1'];?></p>
                        </div>
                        <form method="POST" action="insertcoment.php">
                            <div class="conteudo">
                                    <textarea name="conteudo1" placeholder="Insira seu comentário aqui"></textarea>
                            </div>
                        ...
                        ;}
                            ...
                            $sql2 = "SELECT c.id as c, c.comentario as comentario, c.post_id, c.user_id, u.id as u, u.usuario, f.PATH as foto, p.id as p
                            FROM comentarios c
                            INNER JOIN postagens p ON c.post_id = p.id
