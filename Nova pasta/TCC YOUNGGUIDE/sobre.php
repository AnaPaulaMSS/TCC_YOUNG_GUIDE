<html>
    ...
    <?php
      ...
      ?>
        ...
        <div class="ana">
            ...
            <h5 class="partes">Design | HTML | CSS | JavaScript | Excel</h5>
        </div>
        <div class="gustavo">
          <h1 class="nome">Gustavo</h1>
              <h4>18 anos</h4>
              <div class="texto container">
              ...
              <h5 class="partes">PHP | MYSQL</h5>
        </div>
        <div class="luis">
          <h1 class="nome">Luís</h1>
              <h4>18 anos</h4>
              <div class="texto container">
              ...
              <h5 class="partes">Word | PHP | Gloogle Forms</h5>
        </div>
 ...
 <ul id="slide-out" class="sidenav">
    ...
    <li><a class="waves-effect" href="#!">&nbsp&nbspSobre nós</a></li>
