...
<head>
    ...
    <link href="css/admlix.css" rel="stylesheet">
    <title>Lixeira</title>
...
<?php
    //os includes puxam os dados dos arquivos no conexao puxam os dados do banco de dados e o admverifica puxa a sessão ja existente criada na hora que foi feito o login
        ...
        //da linha 24 a 27 esta sendo feita a verificação da existencia do usuario batendo o registro do banco com a sessão e puxando a foto de perfil do usuario
  ...
  <div class="container">
      ...
      <div class="sugestoes">
      <?php
      // da linha 39 a 73 o codigo esta fazendo o processo para exibir as sugestoes e dar a opcção de escolha de aprovar a sugestão ou recusar
      $sqli = "SELECT * FROM artigos where permissao = 'n' ";
    $resultado = mysqli_query($conexao, $sqli);
      while ($linha=$resultado->fetch_assoc()){
        $_SESSION['valorEspecifico4'] = $linha['id'];
        echo "
        <div class='fundo'>
            <div class='perfil'>
            ...
            <div class='botoes'>
              <form method='post' action='lix_apr_recu.php'>
                  <label>
