...
<?php
        ...
        $row20 = $row['id'];
        $_SESSION['valor7'] = $row1;
        $sql= mysqli_query($conexao,"SELECT * FROM fotos where id_usu ='$row20'") or die ($mysqli->error);
        $arquivos= $sql->fetch_assoc();
        $sql1= mysqli_query($conexao,"SELECT * FROM fotos where id_esp ='$row1'") or die ($mysqli->error);

        $arquivos1= $sql1->fetch_assoc();
      ?>
  <div class="header">
    <div class="nav">
          ...
          <div class="comenta">
            <div class="fundo">
                ...
                <div class="coment">
                    ...
                    <form method="POST" action="insertchat.php">
                        <div class="conteudo">
                                <textarea name="conteudo3" placeholder="Insira seu comentário aqui"></textarea>
                        </div>
